    ...
    return (
        <>
            <div className="mt-6 sm:mt-10 flex flex-col gap-5 items-center">
                ...
                <a href="https://mail.google.com/mail/?view=cm&fs=1&to=bilalhamzazuhry@gmail.com&su=SUBJECT&body=BODY" target="_blank" rel='noreferrer' className="hover:underline font-extralight text-white font-montserrat text-xs sm:text-lg">bilalhamzazuhry@gmail.com</a>
