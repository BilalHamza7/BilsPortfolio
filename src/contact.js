    ...
    return (
        <>
            <div className=" mt-6 lg:mt-12 flex flex-col gap-10 items-center">
                <p className="title_text">Reach Out</p>
                <p className="description_text font-light text-xs sm:text-lg">To Collaborate, chat or a job opportunity, just send a quick message!</p>
